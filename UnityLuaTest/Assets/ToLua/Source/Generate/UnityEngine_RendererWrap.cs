...
public class UnityEngine_RendererWrap
{
	...
	static int get_castShadows(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index castShadows on a nil value");
		}
	}
	...
	static int get_lightmapTilingOffset(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index lightmapTilingOffset on a nil value");
		}
	}
	...
	static int get_lightProbeAnchor(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index lightProbeAnchor on a nil value");
		}
	}
