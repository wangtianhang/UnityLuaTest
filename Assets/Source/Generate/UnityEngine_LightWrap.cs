...
public class UnityEngine_LightWrap
{
	...
	static int get_shadowSoftness(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index shadowSoftness on a nil value");
		}
	}
	...
	static int get_shadowSoftnessFade(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index shadowSoftnessFade on a nil value");
		}
	}
